...
class Album(db.Model):
    ...
    canciones = db.relationship('Cancion', secondary='album_cancion', back_populates='album')
...
class Cancion(db.Model):
    ...
    album = db.relationship('Album', secondary='album_cancion', back_populates='canciones')
